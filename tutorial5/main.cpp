...
int main()
{
    ...
    GLuint textureColorbuffer = generateAttachmentTexture(false, false, 1024, 768);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        cv::Mat screen(768, 1024, CV_8UC3);
        glReadPixels(0, 0, 1024, 768, GL_BGR,GL_UNSIGNED_BYTE,screen.data);// split x and y sizes into bytes
